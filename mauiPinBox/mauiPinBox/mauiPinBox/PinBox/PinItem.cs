...
namespace TemplateUI.Controls
{
    ...
    public class PinItem : TemplatedView
    {
        ...
        public static readonly BindableProperty ItemColorProperty =      
            BindableProperty.Create(nameof(ItemColor), typeof(Color), typeof(PinItem), ColorHelper.Default,
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemColorFocusedProperty =
            BindableProperty.Create(nameof(ItemColorFocused), typeof(Color), typeof(PinItem), ColorHelper.Default, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemBorderColorProperty =
            BindableProperty.Create(nameof(ItemBorderColor), typeof(Color), typeof(PinItem), ColorHelper.Default, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemBorderColorFocusedProperty =
            BindableProperty.Create(nameof(ItemBorderColorFocused), typeof(Color), typeof(PinItem), ColorHelper.Default, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        internal static readonly BindablePropertyKey CurrentItemColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentItemColor), typeof(Color), typeof(PinItem), ColorHelper.Default);
        ...
        internal static readonly BindablePropertyKey CurrentItemBorderColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentItemBorderColor), typeof(Color), typeof(PinItem), ColorHelper.Default);
        ...
        void UpdateCurrent()
        {
            CurrentItemColor = !IsFocused || ItemColorFocused == ColorHelper.Default ? ItemColor : ItemColorFocused;
            CurrentItemBorderColor = !IsFocused || ItemBorderColorFocused == ColorHelper.Default ? ItemBorderColor : ItemBorderColorFocused;
        }
    }
}
