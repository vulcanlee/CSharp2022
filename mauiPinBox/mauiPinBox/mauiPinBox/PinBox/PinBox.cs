...
{
    public class PinBox : ContentView
    {
        ...
        public static readonly BindableProperty ItemColorProperty =
            BindableProperty.Create(nameof(ItemColor), typeof(Color), typeof(PinBox), ColorHelper.Default,
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemColorFocusedProperty =
            BindableProperty.Create(nameof(ItemColorFocused), typeof(Color), typeof(PinBox), ColorHelper.Default,   
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemBorderColorProperty =
            BindableProperty.Create(nameof(ItemBorderColor), typeof(Color), typeof(PinBox), ColorHelper.Default,
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemBorderColorFocusedProperty =
            BindableProperty.Create(nameof(ItemBorderColorFocused), typeof(Color), typeof(PinBox), ColorHelper.Default,
                propertyChanged: OnPinBoxChanged);
        ...
        void UpdatePinItems()
        {
            ...
            foreach(var children in _pinContainer.Children)
            {
                if(children is PinItem pinItem)
                {
                    ...
                    if (pinItem.ItemColor == ColorHelper.Default)
                        pinItem.ItemColor = ItemColor; 
                    
                    if (pinItem.ItemColorFocused == ColorHelper.Default)
                        pinItem.ItemColorFocused = ItemColorFocused;

                    if (pinItem.ItemBorderColor == ColorHelper.Default)
                        pinItem.ItemBorderColor = ItemBorderColor;

                    if (pinItem.ItemBorderColorFocused == ColorHelper.Default)
